...
private:
    ...
    void createRenderPass() {
        ...
        colorAttachment.format = instances->swapChainImageFormat;
    ...
    void createGraphicsPipeline() {
        ...
        viewport.x = 0.0f;
        viewport.y = 0.0f;
        viewport.width = (float) instances->swapChainExtent.width;
        viewport.height = (float) instances->swapChainExtent.height;
        viewport.minDepth = 0.0f;
        viewport.maxDepth = 1.0f;

        VkRect2D scissor{};
        scissor.offset = {0, 0};
        scissor.extent = instances->swapChainExtent;
